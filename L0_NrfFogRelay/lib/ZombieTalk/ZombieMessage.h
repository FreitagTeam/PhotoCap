...
// TYPE_RELAYED_VC
struct VcRelayedMessage
{
	VcRelayedMessage()
	{
		Type = MessageType::TYPE_RELAYED_VC;
		Vcc = 0;
		MessageCount = 0;
		SleepLoops = 0;
		DeviceId = 0;
...
// Used for multiple message types
// TYPE_VC
struct StandardMessage
{
	StandardMessage()
	{
		Type = MessageType::TYPE_STANDARD;
		Vcc = 0;
		MessageCount = 0;
		SleepLoops = 0;
		DeviceId = 0;
...
// TYPE_MNISTIMAGEROW
struct MnistImageRowMessage
{
	MnistImageRowMessage()
	{
		Type = MessageType::TYPE_MNISTIMAGEROW;
		MessageCount = 0;
		SleepLoops = 0;
		DeviceId = 0;
		ImageRow = 0;
